...
class Dashboard2Controller extends Controller
{
    public function index2()
    {
        ...
        $wtSales = DB::selectOne("SELECT COUNT(DISTINCT RPB_IDSURATJALAN) AS wtpending
    ...
    public function getRupiahPickingData()
    {
        $rphpickall = DB::select("WITH
                                        ...
                                        -- Final result
                                        SELECT * FROM pb_zona where jalur <> 'TIDAK PUNYA LOKASI'"); // Pindahkan query dari index() ke sini
    ...
    public function getMonitorPickingData()
    {
        $monitorPicking = DB::select("SELECT  
                                            ...
                                            FROM (
                                                ...
                                                AND PIA_KODEZONA IN ('ZONA 1', 'ZONA 2', 'ZONA 3', 'ZONA 4', 'ZONA 5', 'ZONA 6','ZONA 7', 'ZONA 8', 'ZONA 9', 'ZONA A', 'ZONA B', 'ZONA C','ZONA D', 'ZONA E')
        ...
        $html = view('dashboard.partials.monitor-picking2-table', compact('monitorPicking'))->render();
    ...
    public function getMonitorLoadingData()
    {
        $monitorLoading = DB::select("WITH base_data_idm AS (
                                                        ...
                                                        LEFT JOIN summary_bb_pot bb 
                                                            ON ab.tgl = bb.tgl AND ab.tipe_toko = bb.tipe_toko"); // Pindahkan query dari index() ke sini
        $html = view('dashboard.partials.monitor-loading2-table', compact('monitorLoading'))->render();
