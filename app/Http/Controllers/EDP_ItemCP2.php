...
class EDP_ItemCP2 extends Controller
{
    public function itemcp2()
    {
        return view('edp.itemcp2');
    }
    ...
    public function getData(Request $request)
    {
        ...
        if ($jenis === 'stock') {
            $query = "SELECT 
                        ...
                        WHERE m.PRD_PRDCD IN ('1659190','1658960','1659050','1659200','1659080')
            ...
            $query = "SELECT PRD_PRDCD AS PLU_IGR, 
                            ...
                            WHERE PRD_PRDCD IN ('1659190','1658960','1659050','1659200','1659080')
            ...
            $query = "SELECT  RPB_KODEIGR AS KODE_IGR,
                                ...
                                left join (
                                    ...
                                    group by prc_pluigr
                                        ...
                                        WHERE RPB_PLU1 IN  ('20142353','20142379','20142382','20142393','20142397')
                                        AND RPB_TGLDOKUMEN BETWEEN '2026-06-01' AND current_date -1 
                                ORDER BY 3,7 asc";
        } else {
