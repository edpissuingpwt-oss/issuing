...
$(document).ready(function() {
    ...
    function refreshSL() {
        ...
        $.ajax({
            url: "/dashboardv2/sl-harian?t=" + Date.now(),
            method: "GET",
    ...
    function refreshPbmentah() {
        ...
        var url = "/dashboardv2/pb-mentah/" + type;
    ...
    function refreshPbsl() {
        ...
        var url = "/dashboardv2/pb-sl/" + type;
    ...
    function refreshRupiah() {
        ...
        var url = "/dashboardv2/rupiah-picking/" + type;
    ...
    function refreshPicking() {
        ...
        $.ajax({
            url: "/dashboardv2/monitor-picking?t=" + Date.now(),
            method: 'GET',
            success: function(response) {
    ...
    function refreshLoading() {
        ...
        $.ajax({
            url: "/dashboardv2/monitor-loading?t=" + Date.now(),
            method: 'GET',
            success: function(response) {
    ...
    function loadPbmentah(subTab) {
        ...
        if (subTab === 'idm') { 
            ...
            url = "/dashboardv2/pb-mentah/idm"; 
        }
        else if (subTab === 'omi') { 
            containerId = '#pbmentah-omi-container'; 
            url = "/dashboardv2/pb-mentah/omi"; 
        }
    ...
    function loadPbsl(subTab) {
        ...
        if (subTab === 'idm') { 
            ...
            url = "/dashboardv2/pb-sl/idm"; 
        }
        else if (subTab === 'omi') { 
            containerId = '#pbsl-omi-container'; 
            url = "/dashboardv2/pb-sl/omi"; 
        }
    ...
    function loadRupiah(subTab) {
        ...
        if (subTab === 'all') { 
            ...
            url = "/dashboardv2/rupiah-picking/all";
            type = 'all';
        } else if (subTab === 'idm') { 
            containerId = '#rupiah-idm-container'; 
            url = "/dashboardv2/rupiah-picking/idm";
            type = 'idm';
        } else if (subTab === 'omi') { 
            containerId = '#rupiah-omi-container'; 
            url = "/dashboardv2/rupiah-picking/omi";
            type = 'omi';
        }
    ...
    function loadPicking() {
        ...
        $.ajax({
            url: "/dashboardv2/monitor-picking", method: 'GET',
    ...
    function loadLoading() {
        ...
        $.ajax({
            url: "/dashboardv2/monitor-loading", method: 'GET',
    ...
    function refreshStats() {
        $.ajax({
            url: "/dashboardv2/refresh-stats", method: 'GET',
