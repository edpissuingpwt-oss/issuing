    ...
    <div class="container-fluid">
        ...
        <div class="card card-success">
            ...
            <div class="card-header small-box-issuing-header text-white d-flex justify-content-between align-items-center">
                <h3 class="card-title">LAPORAN BPBR</h3>
            </div>
                ...
                <div class="card-body modern-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group date" id="reservationdate2" data-target-input="nearest">
                            <input type="text" id="tanggal_selesai" class="form-control datetimepicker-input shadow-sm" data-target="#reservationdate2" />
...
function loadTable(status, tanggal_mulai, tanggal_selesai, autoExport = false) {
    $.ajax({
        ...
        success: function(data) {
            ...
            let filenameExcel = 'LAPORAN_BPBR_' + statusUpper + '_' + tanggal_mulai + '_-_' + tanggal_selesai;
            ...
            let table = $("#example1").DataTable({
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        title: 'LAPORAN BPBR ' + statusUpper,
