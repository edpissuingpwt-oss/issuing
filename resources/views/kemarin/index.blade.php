                ...
                <div class="tab-pane fade show active" id="sl" role="tabpanel">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="sl-all" role="tabpanel">
                            @include('kemarin.partials.sl-harian', ['data' => $slHarian['all'] ?? [], 'title' => 'ALL'])
                        </div>
                        <div class="tab-pane fade" id="sl-idm" role="tabpanel">
                            @include('kemarin.partials.sl-harian', ['data' => $slHarian['idm'] ?? [], 'title' => 'IDM'])
                        </div>
                        <div class="tab-pane fade" id="sl-omi" role="tabpanel">
                            @include('kemarin.partials.sl-harian', ['data' => $slHarian['omi'] ?? [], 'title' => 'OMI'])
                        </div>
                    </div>
                </div>
...
<script src="{{ asset('js/kemarin.js') }}"></script>
<script>
