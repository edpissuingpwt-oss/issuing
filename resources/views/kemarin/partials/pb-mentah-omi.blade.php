<div class="card">
    ...
    <div class="card-header bg-gradient-success text-white">
        <h5 class="mb-0">PB MENTAH OMI</h5>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="row mb-3 align-items-center">
            <div class="col-md-6">
                <div class="d-flex align-items-center gap-2">
                    <div class="input-group" style="width: 250px;">
                        ...
                        <input type="text" id="pbmoSearch" class="form-control" placeholder="Cari data...">
                    </div>
                    <div class="d-inline-block ml-2">
                        <select id="pbmoLength" class="form-control form-control-sm d-inline-block" style="width: auto;">
            ...
            <div class="col-md-6 text-right">
                <button type="button" class="btn btn-sm btn-success" onclick="exportToExcel('pbmo-table', 'PB_MENTAH_OMI')">
                    <i class="fas fa-file-excel"></i> Excel
                </button>
                <button type="button" class="btn btn-sm btn-primary" onclick="copyPBMOMI(this)">
        ...
        <div class="table-responsive">
            <table id="pbmo-table" class="table table-bordered table-striped" style="width:100%">
        ...
        <div class="row mt-3">
            <div class="col-sm-12 col-md-6">
                <div id="pbmoInfo" class="dataTables_info">Showing 0 to 0 of 0 entries</div>
            </div>
            <div class="col-sm-12 col-md-6">
                <nav>
                    <ul class="pagination justify-content-end" id="pbmoPagination"></ul>
                </nav>
            </div>
        </div>
    </div>
...
$(document).ready(function() {
    function initTables() {
        if ($('#pbmo-table .data-row').length > 0) {
            setupManualPagination('pbmo-table', 'pbmoSearch', 'pbmoLength', 'pbmoInfo', 'pbmoPagination');
        }
    }
    
    // Cek apakah tab aktif
    var pbmOmiTab = document.getElementById('pbmentah-idm');
    if (pbmOmiTab && (pbmOmiTab.classList.contains('active') || pbmOmiTab.classList.contains('show'))) {
    ...
    if (pbmOmiTab) {
        var observer = new MutationObserver(function(mutations) {
            mutations.forEach(function(mutation) {
                if (mutation.attributeName === 'class') {
                    if (pbmOmiTab.classList.contains('active') || pbmOmiTab.classList.contains('show')) {
                        setTimeout(initTables, 100);
                        observer.disconnect();
                    }
                }
        ...
        observer.observe(pbmOmiTab, { attributes: true });
    }
});
</script>
@endpush