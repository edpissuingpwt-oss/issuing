@extends('layouts.app')
@section('title', 'PICKING KLIK (CETAK MANUAL)')
@section('content')
@push('styles')
            ...
            <form action="" method="post">
                    ...
                    <div class="row">
                            <div class="col-6">
                                ...
                                <input type="text" id="notrans" class="form-control" placeholder="Masukkan No Trans">
                            </div>
                    </div>
...
$(document).ready(function () {
    ...
    $('#submit_form').on('click', function () {
        ...
        if (!notrans) {
            alert('Silakan isi no trans.');
            return;
        }

        // Kirim data via AJAX
        $.ajax({
            url: "{{ route('pickingmanual.table') }}",
            type: "POST",
            data: {
                _token: '{{ csrf_token() }}',
                ...
                var table = $('#example1').DataTable({
                    ...
                    buttons: [
                        ...
                        },
                        {
                            ...
                            filename: 'PICKING_MANUAL_KLIK' + today,
