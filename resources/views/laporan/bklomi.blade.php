...
<div class="container-fluid">
    ...
    <form id="form_timepicking">
        <div class="card-body modern-body">
            ...
            <!-- Dari Tanggal -->
            <div class="mb-4">
                <label for="tanggal_mulai_input" class="form-label fw-semibold">Tanggal Proses :</label>
                <div class="input-group modern-datepicker" id="tanggal_mulai_picker" data-target-input="nearest">
                    <input type="text" id="tanggal_mulai_input" name="tanggal_mulai"
                        ...
                        placeholder="Pilih tanggal proses"/>
...
$(document).ready(function () {
    ...
    // Inisialisasi datepicker hanya untuk tanggal_mulai
    ...
    $('#submit_form').on('click', function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                let tglExcel = formatTanggalExcel(tanggal_mulai);
                ...
                var table = $('#example1').DataTable({
                    ...
                    buttons: [
                        ...
                        },
                        {
                            ...
                            title: 'BKL OMI ' + tglExcel,
                            filename: 'BKL_OMI_' + tglExcel,
