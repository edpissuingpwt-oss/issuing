@extends('layouts.app')
@section('title', 'ITEM DENGAN DIMENSI NULL/0')
                        ...
                        <table id="tabelutama" class="table table-bordered table-striped" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ $row->dn_divisi }}</td>
                                    <td class="text-center">{{ $row->dn_departement }}</td>
                                    <td class="text-center">{{ $row->dn_kategori }}</td>
                                    <td class="text-center">{{ $row->dn_plu }}</td>
                                    <td class="text-center">{{ $row->dn_des }}</td>
                                    <td class="text-center">{{ $row->dn_frac }}</td>
                                    <td class="text-center">{{ $row->dn_flag_jual }}</td>
                                    <td class="text-center">{{ $row->dn_tag }}</td>
                                    <td class="text-center">{{ $row->dn_tinggi }}</td>
                                    <td class="text-center">{{ $row->dn_lebar }}</td>
                                    <td class="text-center">{{ $row->dn_panjang }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
    ...
    var table = $('#tabelutama').DataTable({
        ...
        buttons: [
            ...
            },
            {
                ...
                title: 'ITEM DENGAN DIMENSI NULL/0',
                filename: 'ITEM_DENGAN_DIMENSI_NULL' + today 
            },
            {
                extend: 'print',
