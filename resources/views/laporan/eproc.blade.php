@extends('layouts.app')
@section('title', 'MONITORING UPLOAD PB E-PROC')
@section('content')
@push('styles')
...
<div class="container-fluid">
    ...
    <form id="form_timepicking">
        <div class="card-body modern-body">
            ...
            <!-- Dari Tanggal -->
            <div class="mb-4">
                <label for="tanggal_mulai_input" class="form-label fw-semibold">Tanggal :</label>
                ...
                var table = $('#example1').DataTable({
                    ...
                    buttons: [
                        ...
                        },
                        {
                            ...
                            title: 'UPLOAD PB EPROC',
                            filename: 'UPLOAD_PB_EPROC_' + today
                        }
                    ],
                    scrollX: true,
                    pageLength: 10,
