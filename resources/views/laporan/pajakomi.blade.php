...
@section('title', 'LAPORAN PAJAK OMI')
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="card card-success">
            ...
            <div class="card-header small-box-issuing-header text-white d-flex justify-content-between align-items-center">
                <h3 class="card-title">LAPORAN PAJAK OMI</h3>
            </div>
            <form action="" method="post">
                <div class="card-body modern-body">
                    ...
                    <div class="picker-cards">
                        ...
                        <!-- IDM -->
                        <input type="radio" name="r3" id="radioSuccess2" value="sales" checked>
                        ...
                        <!-- Pot -->
                        <input type="radio" name="r3" id="radioSuccess1" value="bkl">
...
<script>
    $(function () {
            // Pastikan inisialisasi ini ada dan berjalan setelah semua skrip dimuat
