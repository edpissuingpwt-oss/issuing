        ...
        <div class="table-responsive">
            <table id="example1" class="table table-bordered table-striped" style="width:100%">
                ...
                <thead class="bg-gradient-info">
                    <tr>
                        <th class="text-center">No</th>
                        <th class="text-center">TGL PB</th>
                        <th class="text-center">KODE TOKO</th>
                        <th class="text-center">NO PB</th>
                        <th class="text-center">NO KOLI</th>
                        <th class="text-center">PLUIGR</th>
                        <th class="text-center">PLUIDM</th>
                        <th class="text-center">DESKRIPSI</th>
                ...
                <tbody>
                    @foreach($data as $i => $row)
                        <tr>
                            <td>{{ $i + 1 }}</td>
                            <td class="text-center">{{ \Carbon\Carbon::parse($row->tgl_trans)->format('d-M-Y') }}</td>
                            <td class="text-center">{{ $row->kode_toko }}</td>
                            <td class="text-center">{{ $row->no_pb }}</td>
                            <td class="text-center">{{ $row->no_koli }}</td>
                            <td class="text-center">{{ $row->pluigr }}</td>
                            <td class="text-center">{{ $row->pluidm }}</td>
                            <td class="text-center">{{ $row->desk }}</td>
                            <td style="text-align: right">{{ $row->qtyorder }}</td>
                            <td style="text-align: right">{{ $row->qtyreal }}</td>
                            <td style="text-align: right">{{ number_format($row->dpp) }}</td>
