@extends('layouts.app')
@section('title', 'INTRANSIT SPH OMI')
                        ...
                        <table id="tabelutama" class="table table-bordered table-striped" style="width:100%">
                            <thead class="bg-gradient-info text-white">
                                <tr>
                                    ...
                                    <th class="text-center">RPH DF</th>
                                    <th class="text-center">PPN DF</th>
                            ...
                            @foreach ($sphomi as $i => $row)
                                <tr>
                                    ...
                                    <td style="text-align: right">{{ number_format($row->rpdspb, 0, ',', '.') }}</td>
                                    <td style="text-align: right">{{ number_format($row->ppndspb, 0, ',', '.') }}</td>
                                    <td style="text-align: right">{{ number_format($row->rphdf, 0, ',', '.') }}</td>
                                    <td style="text-align: right">{{ number_format($row->ppndf, 0, ',', '.') }}</td>
                                    <td style="text-align: right">{{ number_format($row->total, 0, ',', '.') }}</td>
                                    <td style="text-align: right">{{ number_format($row->ongkir, 0, ',', '.') }}</td>
