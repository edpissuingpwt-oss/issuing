@extends('layouts.app')
@section('title', 'STOCK ITEM DIBAWAH 50%')
    ...
    var table = $('#tabelutama').DataTable({
        ...
        buttons: [
            ...
            },
            {
                ...
                title: 'STOCK DIBAWAH 50 PERSEN',
                filename: 'STOCK_DIBAWAH_50_PERSEN' + today 
            },
            {
                extend: 'print',
