        ...
        <div class="container-fluid">
            <div class="card card-success">
                <div class="card-header small-box-issuing-header text-white d-flex justify-content-between align-items-center">
                    <h3 class="card-title">MONITORING DSPB</h3>
                </div>
                <form id="listkoli-form">
                    @csrf
                    <div class="card-body">
            ...
            <div class="card" id="result_form" style="display: none;">
            </div>
        </div>
    </section>
@endsection
