@extends('layouts.app')
@section('title', 'MASTER DSI GUDANG')
        ...
        <div class="card-header modern-header d-flex justify-content-between align-items-center">
            ...
            <div class="card-body">
                    <div class="table-responsive">
                        <table id="tabelutama" class="table table-bordered table-striped" style="width:100%">
                            <thead class="bg-gradient-info">
                                <tr>
                                    <th class="text-center align-middle">No</th>
                                    <th class="text-center align-middle">PLU IGR</th>
                                    <th class="text-center align-middle">PLU IDM</th>
                                    <th class="text-center align-middle">ALAMAT</th>
                                    <th class="text-center align-middle">DESKRIPSI</th>
                                    <th class="text-center align-middle">FRAC</th>
                                    <th class="text-center align-middle">FLAG</th>
                                    <th class="text-center align-middle">DSI</th>
                                    <th class="text-center align-middle">LPA</th>
                                    <th class="text-center align-middle">LPP</th>
                                    <th class="text-center align-middle">SALES</th>
                                    <th class="text-center align-middle">PKMT</th>
                                    <th class="text-center align-middle">MINOR</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ number_format(round($row->dsi), 0, ".", ",") }}</td>
                                    <td class="text-center">{{ number_format(round($row->lpa), 0, ".", ",") }}</td>
                                    <td class="text-center">{{ number_format(round($row->lpp), 0, ".", ",") }}</td>
                                    <td class="text-center">{{ number_format(round($row->st_sales), 0, ".", ",") }}</td>
                                    <td class="text-center">{{ number_format(round($row->pkmt), 0, ".", ",") }}</td>
                                    <td class="text-center">{{ number_format(round($row->minor), 0, ".", ",") }}</td>
...
$(document).ready(function() {
    ...
    var table = $('#tabelutama').DataTable({
