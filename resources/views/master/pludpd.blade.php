                        ...
                        <table id="pludpd" class="table table-striped table-bordered table-sm" style="min-width: 1000px;">
                            <thead class="bg-gradient-info text-white">
                                <tr>
                                    ...
                                    <th rowspan="2" style="text-align: center;">ACOST PCS</th>
                                    <th rowspan="2">STATUS</th>
                                    <th rowspan="2">PKM</th>
                                    <th rowspan="2">PKMT</th>
                                    <th rowspan="2">M+I</th>
                                    <th rowspan="2">M+O</th>
                                    <th rowspan="2">M+K</th>
                                    <th rowspan="2">M+T</th>
                                    <th rowspan="2">DSI</th>
                                    <th rowspan="2">AVG SALES TOTAL</th>
                                    <th rowspan="2">AVG SALES IDM</th>
                                    <th rowspan="2">PO OUT</th>
                            ...
                            <tbody>
                            @foreach ($pludpd as $index => $row)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    <td>{{ $row->plu_igr }}</td>
                                    <td>{{ $row->plu_idm }}</td>
                                    <td>{{ $row->plu_omi }}</td>
                                    <td>{{ $row->rak_gudang }}</td>
                                    <td>{{ $row->rak_toko }}</td>
                                    <td>{{ $row->deskripsi }}</td>
                                    <td>{{ $row->unit }}</td>
                                    <td>{{ $row->frac }}</td>
