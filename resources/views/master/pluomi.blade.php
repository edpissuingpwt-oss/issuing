@extends('layouts.app')
@section('title', 'MASTER ALAMAT PLU OMI')
                        ...
                        <table id="tokoidm" class="table table-bordered table-striped" style="width:100%">
                            <thead class="bg-gradient-info text-white">
                                <tr>
                                    ...
                                    <th style="text-align: center;">PLU IGR</th>
                                    <th style="text-align: center;">PLU OMI</th>
                                    <th style="text-align: center;">DESKRIPSI</th>
                                    <th style="text-align: center;">UNIT</th>
                                    <th style="text-align: center;">FRAC</th>
                                    <th style="text-align: center;">TAG IGR</th>
                                    <th style="text-align: center;">TAG OMI</th>
                                    <th style="text-align: center;">FLAG</th>
                                    <th style="text-align: center;">LOKASI</th>
                                    <th style="text-align: center;">QTY PLANO</th>
                                    <th style="text-align: center;">NOID</th>
                                    <th style="text-align: center;">STATUS</th>
                                </tr>
                            </thead>
                            <tbody>
                            @foreach ($pluomi as $index => $row)
                                <tr>
                                    <td style="text-align: center;">{{ $index + 1 }}</td>
                                    <td style="text-align: center;">{{ $row->div }}</td>
                                    <td style="text-align: center;">{{ $row->plu_igr }}</td>
                                    <td style="text-align: center;">{{ $row->plu_omi }}</td>
                                    <td style="text-align: center;">{{ $row->deskripsi }}</td>
                                    <td style="text-align: center;">{{ $row->unit }} KM</td>
                                    <td style="text-align: center;">{{ $row->frac }}</td>
                                    <td style="text-align: center;">{{ $row->tag_igr }}</td>
                                    <td style="text-align: center;">{{ $row->tag_omi }}</td>
                                    <td style="text-align: center;">{{ $row->flag }}</td>
                                    <td style="text-align: center;">{{ $row->lokasi }}</td>
                                    <td style="text-align: center;">{{ $row->qty_plano }}</td>
                                    <td style="text-align: center;">{{ $row->lks_noid }}</td>
    ...
    var table = $('#tokoidm').DataTable({
        ...
        buttons: [
            ...
            },
            {
                ...
                title: 'ALAMAT PLU OMI',
                filename: 'ALAMAT_PLU_OMI',
            },
            {
                extend: 'print',
