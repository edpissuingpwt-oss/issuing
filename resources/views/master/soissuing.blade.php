                        ...
                        <table id="tabelutama" class="table table-bordered table-striped" style="width:100%">
                            <thead class="bg-gradient-info">
                                <tr>
                                    ...
                                    <th class="text-center align-middle">PLUIGR</th>
                                    <th class="text-center align-middle">DESK</th>
                                    <th class="text-center align-middle">DSPB</th>
                                    <th class="text-center align-middle">LPP</th>
                                    <th class="text-center align-middle">PLANO</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ $row->dspb }}</td>
                                    <td class="text-center">{{ number_format(round($row->lpp), 0, ".", ",") }}</td>
                                    <td class="text-center">{{ number_format(round($row->plano), 0, ".", ",") }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
