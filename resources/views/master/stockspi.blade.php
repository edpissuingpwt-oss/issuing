                        ...
                        <table id="tabelutama" class="table table-bordered table-striped" style="width:100%">
                            <thead class="bg-gradient-info">
                                <tr>
                                    ...
                                    <th class="text-center align-middle">KODE IGR</th>
                                    <th class="text-center align-middle">KODE SPI</th>
                                    ...
                                    <th class="text-center align-middle">QTY SPI</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ $row->sts_kodeigr }}</td>
                                    <td class="text-center">{{ $row->sts_kodespi }}</td>
                                    <td class="text-center">{{ $row->sts_prdcd }}</td>
                                    <td class="text-center">{{ $row->prd_deskripsipanjang }}</td>
                                    <td class="text-center">{{ number_format(round($row->st_saldoakhir), 0, ".", ",") }}</td>
                                    <td class="text-center">{{ number_format(round($row->sts_qty), 0, ".", ",") }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
