            ...
            <div class="card-body">
                    <div class="table-responsive">
                        <table id="tabelutama" class="table table-bordered table-striped" style="width:100%">
                            ...
                            <tbody>
                            @foreach ($tokoIdm as $index => $row)
                                <tr>
                                    <td style="text-align: center;">{{ $index + 1 }}</td>
                                    <td style="text-align: center;">{{ $row->cluster_idm }}</td>
                                    <td style="text-align: center;">{{ $row->kode_member }}</td>
                                    <td style="text-align: center;">{{ $row->kode_toko }}</td>
                                    <td style="text-align: center;">{{ $row->nama }}</td>
                                    <td class="text-center">{{ \Carbon\Carbon::parse($row->tanggal_go)->format('d-M-Y') }}</td>
                                    <td style="text-align: center;">{{ $row->ass }}</td>
                                    <td style="text-align: center;">{{ $row->am }}</td>
                                    <td style="text-align: center;">{{ $row->jarak_kirim }} KM</td>
                                    <td style="text-align: center;">{{ $row->hari_kirim }}</td>
                                    <td style="text-align: center;">{{ $row->ritase }}</td>
                                    <td style="text-align: center;">{{ $row->mobil }}</td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
