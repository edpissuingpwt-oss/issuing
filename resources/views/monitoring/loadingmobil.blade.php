...
@section('title', 'LOADING MOBIL IDM')
@section('content')
@push('styles')
...
/* Sembunyikan navbar hanya di halaman ini */
        ...
        /* Hilangkan jarak atas setelah navbar di-hide */
        .content-wrapper {
            margin-top: 0 !important;
            padding-top: 0 !important;
        }

        /* Rapatkan section content */
        .content {
            padding-top: 0 !important;
            margin-top: 0 !important;
        }

        /* Card utama naik ke atas */
        .container-fluid {
            padding-top: 0 !important;
        }
        ...
        /* Opsional: sesuaikan margin/sisa konten agar tidak ada ruang kosong */
        .content-wrapper, 
        .main-sidebar {
            margin-top: 0 !important;
            padding-top: 0 !important;
        ...
        .card-header .card-title {
            font-size: 1.8rem; /* sesuaikan besar kecilnya, misal 2rem, 2.5rem */
            font-weight: bold;
        }
        /* Hapus icon sorting bawaan DataTables */
        ...
        /* Hilangkan after bawaan */
        table.dataTable thead .sorting:after,
        table.dataTable thead .sorting_asc:after,
        table.dataTable thead .sorting_desc:after {
            display: none !important;
        }
        /* Paksa halaman naik ke atas */
        .content-wrapper {
        ...
        /* Kalau sidebar juga disembunyikan */
        .main-sidebar {
            display: none !important;
        }
...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card card-success">
            ...
            <div class="card-header small-box-issuing-header text-white d-flex justify-content-center align-items-center">
                <h3 class="card-title h1">LOADING MOBIL IDM</h3>
            </div>
                ...
                <div class="card-body">
                    <div class="form-group clearfix">
                        ...
                        <div class="col-md-3 mb-3">
                            <input type="radio" name="status" id="status1" value="belumscan" hidden>
                            <label for="status1" class="status-option w-100 d-flex flex-column align-items-center justify-content-center p-3">
                            <div class="icon mb-2"><i class="fas fa-dolly fa-2x"></i></div>
                            <h6 class="mb-0">Belum Scan Koli</h6>
                            </label>
                        </div>

                        <!-- Selesai Absen -->
                        <div class="col-md-3 mb-3">
                            <input type="radio" name="status" id="status2" value="belumabsen" hidden>
                            <label for="status2" class="status-option w-100 d-flex flex-column align-items-center justify-content-center p-3">
                            <div class="icon mb-2"><i class="fas fa-truck-moving fa-2x"></i></div>
                            <h6 class="mb-0">Belum Absen Berangkat</h6>
                            </label>
                        </div>

                        <!-- Selesai Sortasi -->
                        <div class="col-md-3 mb-3">
                            <input type="radio" name="status" id="status3" value="belumpulang" hidden>
                            <label for="status3" class="status-option w-100 d-flex flex-column align-items-center justify-content-center p-3">
                            <div class="icon mb-2"><i class="fas fa-truck-moving fa-2x fa-flip-horizontal"></i></div>
                            <h6 class="mb-0">Belum Absen Pulang</h6>
                            </label>
                        </div>

                        <!-- Selesai Proses -->
                        <div class="col-md-3 mb-3">
                            <input type="radio" name="status" id="status4" value="sudahpulang" hidden>
                            ...
                            <h6 class="mb-0">Sudah Absen Pulang</h6>
                            </label>
                        </div>
...
<script>
    ...
    $(document).on('change', 'input[name="status"]', function () {
        ...
        let status = $(this).val();
        if (status === 'belumscan' || status === 'belumabsen') {
    ...
    document.getElementById('submit_form').addEventListener('click', function () {
        ...
        if ((status !== 'belumscan' && status !== 'belumabsen') && (!tanggal_mulai || !tanggal_selesai)) {
            alert('Harap isi tanggal mulai & tanggal selesai!');
            return;
        }

        $.ajax({
            url: "{{ route('loadingmobil.table') }}",
            type: "POST",
            data: {
                _token: "{{ csrf_token() }}",
                flag: status,
