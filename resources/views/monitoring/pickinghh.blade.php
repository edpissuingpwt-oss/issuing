...
input#zona20:checked + .picker-card,
input#pot:checked + .picker-card {
    background: linear-gradient(135deg, #007bff, #00c6ff);
    color: white;
    box-shadow: 0 6px 15px rgba(0, 123, 255, 0.4);
    border-color: #007bff;
}
input#zona20:not(:checked) + .picker-card,
input#pot:not(:checked) + .picker-card {
    background: #f1f6ff;
    color: #007bff;
}
.picker-card:hover {
...
[data-theme="dark"] input#zona20:not(:checked) + .picker-card,
[data-theme="dark"] input#pot:not(:checked) + .picker-card {
    background: #1f2a3a;
    color: #6cb4ff;
}
            ...
            <div class="card-body modern-body">
                ...
                <div class="mb-4">
                    ...
                    <div class="picker-cards">
                        ...
                        <!-- zona20 -->
                        <input type="radio" name="flag" id="zona20" value="zona20">
                        <label for="zona20" class="picker-card">
                            <h5><i class="fas fa-layer-group"></i> ZONA 20 (BAYANGAN)</h5>
                        </label>

                        <!-- Pot -->
                        <input type="radio" name="flag" id="pot" value="pot">
                        <label for="pot" class="picker-card">
                            <h5><i class="fas fa-ruler-combined"></i> POT</h5>
                        </label>
