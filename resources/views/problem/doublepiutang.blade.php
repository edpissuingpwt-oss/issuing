@extends('layouts.app')
@section('title', 'DOUBLE PIUTANG RETUR')
@section('content')
@push('styles')
                ...
                <table id="piutang" class="table table-bordered table-striped" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ $row->trpt_create_dt }}</td>
                            <td class="text-center">{{ $row->trpt_salesinvoiceno }}</td>
                            <td class="text-center">{{ $row->ref_piutang }}</td>
                            ...
                            <td style="text-align: right">{{ number_format(round($row->trpt_ppntaxvalue), 0, ".", ",") }}</td>
                            <td class="text-center">{{ $row->userabsen }}</td>
        ...
        var table2 = $('#piutang').DataTable({
            ...
            buttons: [
                ...
                },
                {
                    ...
                    title: 'DOUBLE PIUTANG RETUR',
                    filename: 'DOUBLE_PIUTANG_RETUR'
                },
                {
                    extend: 'print',
