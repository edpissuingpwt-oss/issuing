@extends('layouts.app')
@section('title', 'GAGAL KIRIM NPB/NPT')
@section('content')
@push('styles')
    ...
    <div class="card modern-card shadow-lg border-0">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="gagalnpb" class="table table-bordered table-striped" style="width:100%">
                    <thead class="bg-gradient-info">
                        <tr>
                            <th rowspan="2" class="text-center align-middle">No</th>
                            <th colspan="2" class="text-center align-middle">TOKO</th>
                            <th colspan="2" class="text-center align-middle">DSPB</th>
                            <th colspan="2" class="text-center align-middle">PB</th>
                            <th rowspan="2" class="text-center align-middle">NPB FILE</th>
                            <th rowspan="2" class="text-center align-middle">JUMLAH ITEM</th>
                            <th rowspan="2" class="text-center align-middle">JENIS</th>
                            <th rowspan="2" class="text-center align-middle">NPB URL</th>
                            <th rowspan="2" class="text-center align-middle">RESPONSE</th>
                            <th colspan="3" class="text-center align-middle">JAM</th>
                            <th rowspan="2" class="text-center align-middle">NPB CONFIRM</th>
                        </tr>
                        <tr>
                            ...
                            <th class="text-center">CREATE WEB</th>
                            <th class="text-center">CREATE CSV</th>
                            <th class="text-center">KIRIM NPB</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ $row->npb_kodetoko }}</td>
                            <td class="text-center">{{ $row->tko_namaomi }}</td>
                            <td class="text-center">{{ $row->npb_tgl_proses }}</td>
                            <td class="text-center">{{ $row->npb_nodspb }}</td>
                            <td class="text-center">{{ $row->npb_tglpb }}</td>
                            <td class="text-center">{{ $row->npb_nopb }}</td>
                            <td class="text-center">{{ $row->npb_file }}</td>
                            <td class="text-center">{{ $row->npb_jml_item }}</td>
                            <td class="text-center">{{ $row->npb_jenis }}</td>
                            <td class="text-center">{{ $row->npb_url }}</td>
                            <td class="text-center">{{ $row->npb_response }}</td>
                            <td class="text-center">{{ $row->npb_create_web }}</td>
                            <td class="text-center">{{ $row->npb_create_csv }}</td>
                            <td class="text-center">{{ $row->npb_kirim }}</td>
                            <td class="text-center">{{ $row->npb_confirm }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
