@extends('layouts.app')
@section('title', 'NPB/NPT TIDAK TERBENTUK')
@section('content')
@push('styles')
                ...
                <table id="gagalnpb" class="table table-bordered table-striped" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ $row->rpb_create_dt }}</td>
                            <td class="text-center">{{ $row->rpb_idsuratjalan }}</td>
                            <td class="text-center">{{ $row->rpb_kodeomi }}</td>
                            <td class="text-center">{{ $row->rpb_nodokumen }}</td>
                            <td class="text-center">{{ $row->jumlah_plu }}</td>
                            <td class="text-center">{{ $row->rp_nilai }}</td>
                            <td class="text-center">{{ $row->rp_ppn }}</td>
        ...
        var table2 = $('#gagalnpb').DataTable({
            ...
            buttons: [
                ...
                },
                {
                    ...
                    title: 'NPB/NPT TIDAK TERBENTUK',
                    filename: 'NPB/NPT_TIDAKTERBENTUK'
                },
                {
                    extend: 'print',
