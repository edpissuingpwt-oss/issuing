    ...
    <div class="container-fluid">
        ...
        <div class="card card-success">
            ...
            <div class="card-header small-box-issuing-header text-white d-flex justify-content-between align-items-center">
                <h3 class="card-title">BA TOKO</h3>
            </div>
            <form action="" method="post">
                <div class="card-body modern-body">
                    ...
                    <div class="picker-cards">
                        ...
                        <!-- IDM -->
                        <input type="radio" name="r3" id="radioSuccess2" value="detail" checked>
                        ...
                        <!-- Pot -->
                        <input type="radio" name="r3" id="radioSuccess1" value="rekap">
