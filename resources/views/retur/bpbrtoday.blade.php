@extends('layouts.app')
@section('title', 'LAPORAN HARIAN BPBR')
@section('content')
@push('styles')
        ...
        var table2 = $('#gagalnpb').DataTable({
            ...
            buttons: [
                ...
                },
                {
                    ...
                    title: 'LAPORAN HARIAN BPBR',
                    filename: 'LAPORAN_HARIAN_BPBR'
                },
                {
                    extend: 'print',
