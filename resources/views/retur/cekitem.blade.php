@extends('layouts.app')
@section('title', 'CEK ITEM TIDAK BISA RETUR IDM')
@section('content')
@push('styles')
    ...
    <div class="card modern-card shadow-lg border-0">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="ciri" class="table table-bordered table-striped" style="width:100%">
                    <thead class="bg-gradient-info">
                        <tr>
                            <th class="text-center">No</th>
                            <th class="text-center">ALAMAT</th>
                            <th class="text-center">TAG_IGR</th>
                            <th class="text-center">TAG_IDM</th>
                            <th class="text-center">PRD_PRDCD</th>
                            <th class="text-center">PLUIDM</th>
                            <th class="text-center">DESKRIPSI</th>
                            <th class="text-center">FRAC</th>
                            <th class="text-center">HGB_KODESUPPLIER</th>
                            <th class="text-center">SUP_NAMASUPPLIER</th>
                            <th class="text-center">HARGA_BELI</th>
                            <th class="text-center">QTY_DPD</th>
                            <th class="text-center">LPP</th>
                            <th class="text-center">MINOR_IGR</th>
                            <th class="text-center">MINOR_IDM</th>
                            <th class="text-center">PERMINTAAN_PBIDM</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ $row->hgb_kodesupplier }}</td>
                            <td class="text-center">{{ $row->sup_namasupplier }}</td>
                            <td class="text-center">{{ $row->harga_beli }}</td>
                            <td class="text-center">{{ $row->qty_dpd }}</td>
                            <td class="text-center">{{ $row->lpp }}</td>
                            <td class="text-center">{{ $row->minor_igr }}</td>
                            <td class="text-center">{{ $row->minor_idm }}</td>
                            <td class="text-center">{{ $row->permintaan_pbidm }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
        ...
        var table2 = $('#ciri').DataTable({
            ...
            buttons: [
                ...
                },
                {
                    ...
                    title: 'CEK ITEM RETUR IDM',
                    filename: 'CEK_ITEM_RETUR_IDM'
                },
                {
                    extend: 'print',
