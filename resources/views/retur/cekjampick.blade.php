    ...
    <div class="container-fluid">
        ...
        <div class="card card-info">
            <div class="card-header small-box-issuing-header text-white d-flex justify-content-between align-items-center">
                <h3 class="card-title">CEK JAM PICKING</h3>
            </div>
            <form id="form_itempicking">
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                            <label for="nokoli">NO KOLI :</label>
                            <input type="text" id="nokoli" name="nokoli" class="form-control" placeholder="Masukkan No Koli">
                        </div>
                    </div>
                </div>
            </form>
