@extends('layouts.app')
@section('title', 'OUTSTANDING RETUR IDM')
...
input#reguler:checked + .picker-card,
input#proforma:checked + .picker-card,
input#other:checked + .picker-card {
    background: linear-gradient(135deg, #007bff, #00c6ff);
    color: white;
    box-shadow: 0 6px 15px rgba(0, 123, 255, 0.4);
    border-color: #007bff;
}
input#reguler:not(:checked) + .picker-card,
input#proforma:not(:checked) + .picker-card,
input#other:not(:checked) + .picker-card {
    background: #f1f6ff;
    color: #007bff;
}
[data-theme="dark"] input#reguler:not(:checked) + .picker-card,
[data-theme="dark"] input#proforma:not(:checked) + .picker-card,
[data-theme="dark"] input#other:not(:checked) + .picker-card {
    background: #1f2a3a;
    color: #6cb4ff;
}
.picker-card:hover {
            ...
            <div class="card-body modern-body">
                ...
                <div class="mb-4">
                    ...
                    <div class="picker-cards">
                        ...
                        <!-- Reguler -->
                        <input type="radio" name="flag" id="reguler" value="reguler">
                        <label for="reguler" class="picker-card">
                            <h5>
                        ...
                        <!-- Pot -->
                        <input type="radio" name="flag" id="proforma" value="proforma">
                        <label for="proforma" class="picker-card">
                            <h5>
                        ...
                        <!-- Reguler -->
                        <input type="radio" name="flag" id="other" value="other">
                        <label for="other" class="picker-card">
                            <h5>
                                {{-- <i class="fas fa-copy"></i> --}}
                                 LAIN - LAIN </h5>
                        </label>
