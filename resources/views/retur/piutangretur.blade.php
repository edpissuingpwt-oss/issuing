...
@section('title', 'CEK PIUTANG RETUR')
@section('content')
@push('styles')
    ...
    <div class="container-fluid">
        ...
        <div class="card card-success">
            ...
            <div class="card-header small-box-issuing-header text-white d-flex justify-content-between align-items-center">
                <h3 class="card-title">CEK PIUTANG RETUR</h3>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input type="text" id="namatoko" class="form-control" placeholder="Gunakan Huruf kapital">
                            </div>
                        </div>
                </form>
            </div>
            <form action="" method="post">
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                            <label for="no_nrb">NO NRB :</label>
                            <input type="text" id="nonrb" class="form-control" placeholder="NO NRB">
                        </div>
                    </div>
                </div>
            </form>
                        ...
                        "buttons": ["copy", 
                            {
                                ...
                                customize: function (win) {
                                    $(win.document.body).find('h1').text('Piutang Retur');
