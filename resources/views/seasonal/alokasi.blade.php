@extends('layouts.app')
@section('title', 'ALOKASI SEASONAL')
@section('content')
@push('styles')
                ...
                <table id="piutang" class="table table-bordered table-striped" style="width:100%">
                    <thead class="bg-gradient-info">
                        <tr>
                            ...
                            <th class="text-center">PLU IDM</th>
                            ...
                            <th class="text-center">ACOST CTN</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ \Carbon\Carbon::parse($row->as_tglkirim)->format('d-m-Y') }}</td>
                            <td class="text-center">{{ $row->zona }}</td>
                            <td class="text-center">{{ $row->alamat }}</td>
                            <td class="text-center">{{ $row->lks_noid }}</td>
                            <td class="text-center">{{ $row->toko }}</td>
                            <td class="text-center">{{ $row->as_pluidm }}</td>
                            <td class="text-center">{{ $row->as_pluigr }}</td>
                            <td class="text-center">{{ $row->desk }}</td>
                            <td class="text-center">{{ $row->frac }}</td>
                            <td style="text-align: right">{{ number_format(round($row->qtypcs_target), 0, ".", ",") }}</td>
                            <td style="text-align: right">{{ number_format(round($row->target_ctn), 0, ".", ",") }}</td>
                            <td style="text-align: right">{{ number_format(round($row->acostpcs), 0, ".", ",") }}</td>
                            <td style="text-align: right">{{ number_format(round($row->acostctn), 0, ".", ",") }}</td>
        ...
        var table2 = $('#piutang').DataTable({
            ...
            buttons: [
                ...
                },
                {
                    ...
                    title: 'ALOKASI SEASONAL',
                    filename: 'ALOKASI_SEASONAL' + today
                },
                {
                    extend: 'print',
